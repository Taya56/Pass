...
# Однако возникает возникает проблема в бесконечном повторение цикла. Делаю ограничение до длины grades.
# Возникла проблема в том что у students и grades, разный тип данных, т.к. они не совместимы. Потому меня тип данных у students, на список.
